      ...
      <ul class="navbar-nav ml-auto">
        <li class="nav-item dropdown active">
          ...
          <ul class="dropdown-menu">
            <li><a class="dropdown-item active" href="/">Homepage</a></li>
            <li><a class="dropdown-item" href="/homepage-2">Homepage 2</a></li>
          </ul>
        </li>
        <li class="nav-item dropdown @@pages">
          ...
          <!-- Dropdown list -->
          <ul class="dropdown-menu">
            <li><a class="dropdown-item @@team" href="/team">Team</a></li>
            <li><a class="dropdown-item @@career" href="/career">Career</a></li>
          </ul>
        </li>
